...
@Component({
  selector: 'app-creditos-capturar-entregas-lista',
  templateUrl: './creditos-capturar-entregas-lista.component.html',
  styleUrls: ['./creditos-capturar-entregas-lista.component.css']
})
export class CreditosCapturarEntregasListaComponent implements OnInit {
