...
@Component({
  selector: 'app-creditos-programar-entregas-lista',
  templateUrl: './creditos-programar-entregas-lista.component.html',
  styleUrls: ['./creditos-programar-entregas-lista.component.css']
})
export class CreditosProgramarEntregasListaComponent implements OnInit {
  ...
  printFormatoEntregasCredito() {
    ...
    if (this.inputFechaEntrega.nativeElement.value.length > 0) {
      ...
      this.getCreditos(this.currentPage, 100, fechaParam);
  ...
  limpiar() {
    ...
    this.getCreditos(this.currentPage, 100, null);
  }
